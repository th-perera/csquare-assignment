                                    ...
                                    <form action="" method="POST">
                                            ...
                                            <div class="col">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <select class="form-select" id="inputItemCategory"
                                                        name="item_category">
                                                        <option
                                                            <?php if(isset($item['item_category']) && $item['item_category'] == '') echo 'selected'; ?>
                                                        ...
                                                        <?php
                                                            ...
                                                            foreach ($result as $category) {
                                                                ...
                                                                if(isset($item['item_category']) && $item['item_category'] == $category['id']) echo 'selected';
                                        ...
                                        <div class="form-floating mb-3">
                                            <select class="form-select" id="inputItemSubCategory"
                                                ...
                                                <option
                                                    <?php if(isset($item['item_subcategory']) && $item['item_subcategory'] == '') echo 'selected'; ?>
                                                ...
                                                <?php
                                                            ...
                                                            foreach ($result as $subCategory) {
                                                                ...
                                                                if(isset($item['item_subcategory']) && $item['item_subcategory'] == $subCategory['id']) echo 'selected';
